...
if __name__ == '__main__':
    ...
    checkpoint_file = '/mnt/lustre/yanhongchang/project/one-rpn/mmdetection/checkpoints/libra_faster_rcnn_r50_fpn_1x_noclip_trainval_epoch_40.pth'
    ...
    saveimgpath = '/mnt/lustre/yanhongchang/project/one-rpn/mmdetection/demo/work_dirs/out_img/inference'
    savetxtpath = '/mnt/lustre/yanhongchang/project/one-rpn/mmdetection/demo/work_dirs/out_img/txt'
