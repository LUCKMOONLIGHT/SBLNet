...
if __name__ == '__main__':
    ...
    config_file = '/mnt/lustre/yanhongchang/project/one-rpn/mmdetection/configs/myconfig/test_cascade_rcnn_x101_64x4d_fpn_1x_512.py'
    ...
    saveimgpath = '/mnt/lustre/yanhongchang/project/one-rpn/mmdetection/demo/work_dirs/out_img/cascaded_x101/crop512/inference'
    savetxtpath = '/mnt/lustre/yanhongchang/project/one-rpn/mmdetection/demo/work_dirs/out_img/cascaded_x101/crop512/txt'
    osp(saveimgpath)
    osp(savetxtpath)
